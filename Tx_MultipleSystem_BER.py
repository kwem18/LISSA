...
def main(powers,repetitions,folder):
    ...
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    print("!!!!!! THIS MUST BE THE COMPUTER USED FOR TRANSMITTING !!!!!")
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    ...
    for i in range(1, repetitions + 1):
        ...
        for j in powers:
            ...
            if success != 1:
                print("Test cancelled because of percistant errors.")
            else:
                ...
                print"RerunningGRC to ensure next one works"
                grc = All_One_Comp.All_One_Comp(3)
                grc.start()
                sleep(2)
                grc.stop()
                sleep(1)
                ...
                print"------------------------------- Final Result -------------------------------"
                print"Results viewable on the receiving computer."
